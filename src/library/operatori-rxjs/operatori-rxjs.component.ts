...
//  OPERATORI più utilizzati --> funzionano a cascata
  ...
  operatoreSwitchMap1 : Observable<{id:number, name : string}> = of({id : 1, name : 'quokka'});
  operatoreSwitchMap2 : Observable<{id:number, name : string}> = of({id : 2, name : 'koala'});
  ...
  methodSwitchMap(){
    this.postService.getChiaveAccessoSwitchMap()
    .pipe(
